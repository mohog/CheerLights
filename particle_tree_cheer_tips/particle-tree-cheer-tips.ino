...
void setColor(String color) {
  ...
  for(int iColor = 0; iColor <= 12; iColor++)
  {
    if(color == colorName[iColor])
    {
        ...
        leds.setPixelColor(2,colorRGB[old5Color][0], colorRGB[old5Color][1], colorRGB[old5Color][2]);
        leds.setPixelColor(3,0, 255, 0);
        leds.setPixelColor(4,0, 255, 0);
        leds.setPixelColor(5,0, 255, 0);
        leds.setPixelColor(6,colorRGB[old3Color][0], colorRGB[old3Color][1], colorRGB[old3Color][2]);
        leds.setPixelColor(7,0, 255, 0);
        leds.setPixelColor(8,0, 255, 0);
        leds.setPixelColor(9,colorRGB[old1Color][0], colorRGB[old1Color][1], colorRGB[old1Color][2]);
        leds.setPixelColor(10,0, 255, 0);
        leds.setPixelColor(11,0, 255, 0);
        leds.setPixelColor(12,colorRGB[iColor][0], colorRGB[iColor][1], colorRGB[iColor][2]);
        leds.setPixelColor(13,0, 255, 0);
        leds.setPixelColor(14,0, 255, 0);
        leds.setPixelColor(15,colorRGB[old2Color][0], colorRGB[old2Color][1], colorRGB[old2Color][2]);
        leds.setPixelColor(16,0, 255, 0);
        leds.setPixelColor(17,0, 255, 0);
        leds.setPixelColor(18,colorRGB[old4Color][0], colorRGB[old4Color][1], colorRGB[old4Color][2]);
        leds.setPixelColor(19,0, 255, 0);
        leds.setPixelColor(20,0, 255, 0);
        leds.setPixelColor(21,0, 255, 0);
        leds.setPixelColor(22,colorRGB[old6Color][0], colorRGB[old6Color][1], colorRGB[old6Color][2]);
        leds.setPixelColor(23,0, 255, 0);
        leds.setPixelColor(24,0, 255, 0);
        leds.show();
