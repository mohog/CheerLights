...
void setColor(String color) {
  ...
  for(int zColor = 0; zColor <= 12; zColor++)
  {
    if(color == colorName[zColor])
    {
        // Don't update the lights if it already is that color
        if(zColor == currentColor) {
            return;
        }
        ...
        leds.setPixelColor(0,colorRGB[wColor][0], colorRGB[wColor][1], colorRGB[wColor][2]);
        leds.setPixelColor(1,colorRGB[uColor][0], colorRGB[uColor][1], colorRGB[uColor][2]);
        leds.setPixelColor(2,colorRGB[sColor][0], colorRGB[sColor][1], colorRGB[sColor][2]);
        leds.setPixelColor(3,colorRGB[qColor][0], colorRGB[qColor][1], colorRGB[qColor][2]);
        leds.setPixelColor(4,colorRGB[oColor][0], colorRGB[oColor][1], colorRGB[oColor][2]);
        leds.setPixelColor(5,colorRGB[mColor][0], colorRGB[mColor][1], colorRGB[mColor][2]);
        leds.setPixelColor(6,colorRGB[kColor][0], colorRGB[kColor][1], colorRGB[kColor][2]);
        leds.setPixelColor(7,colorRGB[iColor][0], colorRGB[iColor][1], colorRGB[iColor][2]);
        leds.setPixelColor(8,colorRGB[gColor][0], colorRGB[gColor][1], colorRGB[gColor][2]);
        leds.setPixelColor(9,colorRGB[eColor][0], colorRGB[eColor][1], colorRGB[eColor][2]);
        leds.setPixelColor(10,colorRGB[cColor][0], colorRGB[cColor][1], colorRGB[cColor][2]);
        leds.setPixelColor(11,colorRGB[aColor][0], colorRGB[aColor][1], colorRGB[aColor][2]);
        leds.setPixelColor(12,colorRGB[zColor][0], colorRGB[zColor][1], colorRGB[zColor][2]);
        leds.setPixelColor(13,colorRGB[bColor][0], colorRGB[bColor][1], colorRGB[bColor][2]);
        leds.setPixelColor(14,colorRGB[dColor][0], colorRGB[dColor][1], colorRGB[dColor][2]);
        leds.setPixelColor(15,colorRGB[fColor][0], colorRGB[fColor][1], colorRGB[fColor][2]);
        leds.setPixelColor(16,colorRGB[hColor][0], colorRGB[hColor][1], colorRGB[hColor][2]);
        leds.setPixelColor(17,colorRGB[jColor][0], colorRGB[jColor][1], colorRGB[jColor][2]);
        leds.setPixelColor(18,colorRGB[lColor][0], colorRGB[lColor][1], colorRGB[lColor][2]);
        leds.setPixelColor(19,colorRGB[nColor][0], colorRGB[nColor][1], colorRGB[nColor][2]);
        leds.setPixelColor(20,colorRGB[pColor][0], colorRGB[pColor][1], colorRGB[pColor][2]);
        leds.setPixelColor(21,colorRGB[rColor][0], colorRGB[rColor][1], colorRGB[rColor][2]);
        leds.setPixelColor(22,colorRGB[tColor][0], colorRGB[tColor][1], colorRGB[tColor][2]);
        leds.setPixelColor(23,colorRGB[vColor][0], colorRGB[vColor][1], colorRGB[vColor][2]);
        leds.setPixelColor(24,colorRGB[xColor][0], colorRGB[xColor][1], colorRGB[xColor][2]);
        leds.show();
